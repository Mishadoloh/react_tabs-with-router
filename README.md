...
- Open one more terminalа4ааак and run tests with `npm test` to ensure your solution is correct.
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Mishadoloh.github.io/react_tabs-with-router/) and add it to the PR description.
